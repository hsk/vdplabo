...
class V9938:
    ...
    def __init__(self):
        ...
        # sprite2固有: sprite color tableの先頭アドレスはSATアドレスから
        # 自動的に(512を引いた値に)決まる。専用レジスタは存在しない。
        self.sprite_color_table = self.sprite_attribute_table - 512
    ...
    def set_sprite_color(self, ch, colors):
        addr = self.sprite_color_table + ch * 8
        for i in range(8):
    ...
    def render_line_sprites(self, surface, y):
        ...
        size = (16 if self.sprite_size16 else 8) * mag
        for i in range(self.SPRITE_COUNT):
            ...
            if self.sprite_size16:
                ...
                blocks = [spr_ptn]
            row_color = self.vram[self.sprite_color_table + i * 8 + py]
...
if __name__ == "__main__":
    ...
    def machine(rom):
        ...
        while True:
            ...
            if vdp.sprite_9s:
                print(f"SPRITE OVERFLOW: 9th sprite={vdp.sprite_9s_index}")
