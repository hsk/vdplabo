...
// ----------------------------------------
// SDLに依存しないエンジン本体。stage2-2.cpp から利用する。
// python/sprite1/stage2-2.py のC++移植版。
// stage2-1 に「5th sprite」判定(手前から4枚を超えたら以降は描画しない)を
// 追加し、実機と同じくスプライト番号の小さい順(0番から)を優先する。
// まだ衝突判定はない。
#pragma once
