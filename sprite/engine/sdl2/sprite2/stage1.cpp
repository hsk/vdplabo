...
// ----------------------------------------
// stage1.hpp の V9938 クラスを読み込んで動かすだけの薄いドライバ。
// ROM クラスが python 版の ROM クラスと同じ内容(29個のスプライトを
// 跳ね回らせつつ、CCビットを立てた3個のスプライトが重なり合う
// 「ベン図」デモを再現する)を再現する。
#include "stage1.hpp"
...
public:
    ...
    void run(int frame) {
        ...
        int venn_pattern = vdp_.sprite_size16 ? 8 : 2;
